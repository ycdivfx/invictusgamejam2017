...
public class DeadzoneCamera : MonoBehaviour 
{
    ...
    public void Update()
    {
        ...
        camWorldRect.min = new Vector2(smoothPos.x - _camera.aspect * _camera.orthographicSize, smoothPos.y - OrthoSize);
        camWorldRect.max = new Vector2(smoothPos.x + _camera.aspect * _camera.orthographicSize, smoothPos.y + OrthoSize);
